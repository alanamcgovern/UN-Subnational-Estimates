...
dhsStata.files<- c("LBBR6ADT/LBBR6AFL.dta","LBBR7ADT/LBBR7AFL.dta")

### please fill in the file name containing the DHS GPS data ###
dhsFlat.files<-c('LBGE6AFL','LBGE7AFL')

### please fill in the following information ####
dhs_survey_years<- c(2013,2020) # years of the DHS surveys
survey_years <- c(2013,2020)
frame_years <- c(2008,2008)

### please fill in the path to country shape files ####
poly.path <- paste0("shapeFiles/gadm41_LBR_shp")
