...
poly.layer.adm1 <- paste('sle_adm1_province_mic') # specify the name of the admin2 shape file
poly.layer.adm2 <- paste('sle_adm2_districts_mic_cleaned') # specify the name of the admin2 shape file


poly.label.adm1 <- "poly.adm1@data$province"
poly.label.adm2 <- "poly.adm2@data$new_distri"
