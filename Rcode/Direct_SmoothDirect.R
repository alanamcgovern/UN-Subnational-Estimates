  ...
  for(survey in survey_years){
    ...
    for(area in admin1.names$GADM){
      ...
      if(exists('direct.admin2.u5')){
        #adjustment for 3-year period U5MR
        admin2.to.admin1 <- 
          births.list[[1]][!duplicated(births.list[[1]]$admin2.name),] %>% 
          dplyr::select(GADM.adm2=admin2.name,Internal.adm2=admin2.char,
                        GADM.adm1 = admin1.name)
        admin2.to.admin1 <- data.frame(admin2.to.admin1,
                                       Internal.adm1 = NA)
        admin2.to.admin1$Internal.adm1 <- 
          admin1.names$Internal[match(admin2.to.admin1$GADM.adm1,
                                      admin1.names$GADM)]
        admin2s <- 
          admin2.to.admin1$Internal.adm2[admin2.to.admin1$Internal.adm1 == 
                                           as.character(area.int)]
        tmp.adj <- 
          SUMMER::getAdjusted(direct.admin2.u5[direct.admin2.u5$region %in% 
                                                 admin2s &
                                                 direct.admin2.u5$surveyYears == 
                                                 survey,],
                              ratio = adj.frame.tmp, 
        ...
        #adjustment for yearly U5MR
        tmp.adj <- 
          SUMMER::getAdjusted(direct.admin2.yearly.u5[
            direct.admin2.yearly.u5$region %in% admin2s &
        ...
        #adjustment for 3-year period NMR
        admin2.to.admin1 <- 
          births.list.nmr[[1]][!duplicated(births.list.nmr[[1]]$admin2.name),] %>% 
          dplyr::select(GADM.adm2=admin2.name,
                        Internal.adm2=admin2.char,GADM.adm1 = admin1.name)
        admin2.to.admin1 <- data.frame(admin2.to.admin1,
                                       Internal.adm1 = NA)
        admin2.to.admin1$Internal.adm1 <-
          admin1.names$Internal[match(admin2.to.admin1$GADM.adm1,
        ...
        admin2s <- 
          admin2.to.admin1$Internal.adm2[admin2.to.admin1$Internal.adm1 == 
                                           as.character(area.int)]
        tmp.adj <- 
          SUMMER::getAdjusted(direct.admin2.nmr[direct.admin2.nmr$region %in% 
                                                  admin2s &
                                                  direct.admin2.nmr$surveyYears
                                                == survey,],
                              ratio = adj.frame.tmp, 
                              logit.lower = NULL,
                              logit.upper = NULL,
        ...
        #adjustment for yearly NMR
        tmp.adj <- 
          SUMMER::getAdjusted(direct.admin2.yearly.nmr[
            direct.admin2.yearly.nmr$region %in% admin2s &
        ...
        direct.admin2.yearly.nmr[direct.admin2.yearly.nmr$region %in% admin2s &
                                   direct.admin2.yearly.nmr$surveyYears == 
                                   survey,] <- 
...
#U5MR
fit.natl.yearly.u5 <- 
  smoothDirect(data.natl.yearly.u5, geo = NULL, Amat = NULL,
               ...
               is.yearly = F)
res.natl.yearly.u5 <- 
  getSmoothed(fit.natl.yearly.u5, year_range = c(beg.year, max(end.proj.years)),
              year_label = as.character(beg.year:max(end.proj.years)))
...
#NMR
fit.natl.yearly.nmr <- 
  smoothDirect(data.natl.yearly.nmr, geo = NULL, Amat = NULL,
               year_label = as.character(beg.year:max(end.proj.years)),
               time.model = time.model,
               year_range = c(beg.year, max(end.proj.years)), 
               control.inla = list(strategy = "adaptive", int.strategy = "eb"),
               is.yearly = F)
res.natl.yearly.nmr <-
  getSmoothed(fit.natl.yearly.nmr,
              year_range = c(beg.year, max(end.proj.years)),
              year_label = as.character(beg.year:max(end.proj.years)))
...
## Load IGME estimates ------------------------------------------------------
{
  ...
  igme.ests.nmr$SD <- 
    (igme.ests.nmr$UPPER_BOUND - igme.ests.nmr$LOWER_BOUND)/(2*1.645*1000)
